            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="btn-group btn-space float-right">
                        ...
                        <a href="{{ route('admin.slider.create') }}" class="btn btn-light btn-sm float-right mr-2">Yeni Ekle</a>
                    </div>
                    <h3>Sliderlar</h3>
                    ...
                    <div class="row">
                        <div class="table-sorter-wrapper col-lg-12 table-responsive">
                            <table id="sortable-table-2" class="table table-striped">
                                <thead>
                                <tr>
                                    <th class="sortStyle">Slider Adı<i class="ti-angle-down"></i></th>
                                ...
                                @foreach($sliders as $slider)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('admin.slider.edit', $slider->id) }}" class="btn btn-sm btn-primary mr-2 float-left" title="Düzenle"><i class="fa fa-edit"></i></a>
